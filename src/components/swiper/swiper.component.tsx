                        ...
                        <SwiperSlide key={slide}>
                            ...
                            >
                                <Stack sx={{ order: { xs: 1, md: 0 }, px: 2 }}>
                                    <Typography variant="h4" component="h1" textAlign="center" maxWidth={550} mb={2}>
                                        Get Started with best place for best Products
                                    </Typography>
                                    <Typography variant="subtitle1" textAlign="center" mb={3}>
                                        Safe and speed purchasing
                                    </Typography>
                                    <Button variant="contained" size="large" sx={{ m: "auto", px: 8, py: 2, borderRadius: "50px", zIndex: 1 }}>
                                        Get Started
                                    </Button>
                                </Stack>
                                <Stack direction="row" alignItems="center" sx={{ width: { xs: '75%', md: '90%' }, overflow: 'hidden', mt: { xs: 3, md: 0 } }}>
                                    <LaptopImage />
                                    <ConncetorImage />
                                    <BoxImage />
                                </Stack>
